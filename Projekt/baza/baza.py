...
class otomoto:
    def __init__(self, id, marka, rocznik, cena):
        self.id = id
        self.marka = marka
...
class samochody(otomoto):
    def __init__(self, marka, model, rocznik, skrzynia, cena):
        ...
        self.model = model
        super().__init__(marka, rocznik, cena)

class motocykle(otomoto):
    def __init__(self, id, marka, rocznik, cena, model):
        self.model = model
        super().__init__(id, marka, rocznik, cena)

class czesci(otomoto):
    def __init__(self, id, marka, rocznik, cena, nazwa, stan):
        self.nazwa = nazwa
        self.stan = stan
        super().__init__(id, marka, rocznik, cena)
...
class bmw(samochody):
    def __init__(self, marka, model, rocznik, skrzynia, cena):
        super().__init__(marka, model, rocznik, skrzynia, cena)

class mercedes(samochody):
    def __init__(self, marka, model, rocznik, skrzynia, cena):
        super().__init__(marka, model, rocznik, skrzynia, cena)

class mazda(samochody):
    def __init__(self, marka, model, rocznik, skrzynia, cena):
        super().__init__(marka, model, rocznik, skrzynia, cena)

class volkswagen(samochody):
    def __init__(self, marka, model, rocznik, skrzynia, cena):
        super().__init__(marka, model, rocznik, skrzynia, cena)

volkswagen_instance = volkswagen('Volkswagen', 'Golf', 2021, 'manualna',90000)
print(volkswagen_instance.marka, volkswagen_instance.model, volkswagen_instance.rocznik, volkswagen_instance.skrzynia, volkswagen_instance.cena)
